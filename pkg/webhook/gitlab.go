...
func (s *gitlabHandler) HandleEvent(repo string, eventType string, commit string, payload []byte, secret string) {
...
func (s *gitlabHandler) build(eventType, commit string, payload []byte, proj *brigade.Project) error {
